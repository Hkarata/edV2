...
public record CreateUserRequest
{
    ...
    [SensitiveData] public DateTime DateOfBirth { get; set; }

    [PiiData] public string PhoneNumber { get; set; } = string.Empty;

    public string Email { get; set; } = string.Empty;

    [SensitiveData] public string Password { get; set; } = string.Empty;
}